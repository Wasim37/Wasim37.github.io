...
export declare const CommonBorder: <W extends Menclose, N>(render: Renderer<W, N>) => (side: "left" | "right" | "bottom" | "top") => DefPair<W, N>;
export declare const CommonBorder2: <W extends Menclose, N>(render: Renderer<W, N>) => (name: string, side1: "left" | "right" | "bottom" | "top", side2: "left" | "right" | "bottom" | "top") => DefPair<W, N>;
export declare const CommonDiagonalStrike: <W extends Menclose, N>(render: (sname: string) => Renderer<W, N>) => (name: string) => DefPair<W, N>;
export declare const CommonDiagonalArrow: <W extends Menclose, N>(render: Renderer<W, N>) => (name: string) => DefPair<W, N>;
export declare const CommonArrow: <W extends Menclose, N>(render: Renderer<W, N>) => (name: string) => DefPair<W, N>;
