...
function ComplexityMathItemMixin(BaseMathItem, computeComplexity) {
    return (function (_super) {
        ...
        class_1.prototype.complexity = function (document) {
            if (this.state() < MathItem_js_1.STATE.COMPLEXITY && !this.isEscaped) {
...
function ComplexityMathDocumentMixin(BaseDocument) {
    ...
    return _a = (function (_super) {
        ...
        _a.OPTIONS = __assign(__assign(__assign({}, BaseDocument.OPTIONS), visitor_js_1.ComplexityVisitor.OPTIONS), { ComplexityVisitor: visitor_js_1.ComplexityVisitor, renderActions: Options_js_1.expandable(__assign(__assign({}, BaseDocument.OPTIONS.renderActions), { complexity: [MathItem_js_1.STATE.COMPLEXITY] })) }),
        _a;
}
