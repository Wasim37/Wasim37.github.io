...
function AssistiveMmlMathItemMixin(BaseMathItem) {
    return (function (_super) {
        ...
        class_1.prototype.assistiveMml = function (document) {
            if (this.state() >= MathItem_js_1.STATE.ASSISTIVEMML || this.isEscaped)
                return;
...
function AssistiveMmlMathDocumentMixin(BaseDocument) {
    ...
    return _a = (function (_super) {
        ...
        _a.OPTIONS = __assign(__assign({}, BaseDocument.OPTIONS), { renderActions: Options_js_1.expandable(__assign(__assign({}, BaseDocument.OPTIONS.renderActions), { assistiveMml: [MathItem_js_1.STATE.ASSISTIVEMML] })) }),
        _a.assistiveStyles = {
            'mjx-assistive-mml': {
