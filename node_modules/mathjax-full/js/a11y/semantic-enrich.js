...
function EnrichedMathItemMixin(BaseMathItem, MmlJax, toMathML) {
    return (function (_super) {
        ...
        class_1.prototype.enrich = function (document) {
            if (this.state() >= MathItem_js_1.STATE.ENRICHED || this.isEscaped)
                return;
...
function EnrichedMathDocumentMixin(BaseDocument, MmlJax) {
    ...
    return _a = (function (_super) {
        ...
        _a.OPTIONS = __assign(__assign({}, BaseDocument.OPTIONS), { enrichSpeech: 'none', renderActions: Options_js_1.expandable(__assign(__assign({}, BaseDocument.OPTIONS.renderActions), { enrich: [MathItem_js_1.STATE.ENRICHED], attachSpeech: [MathItem_js_1.STATE.ATTACHSPEECH] })) }),
        _a;
}
